...
?>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add Features</h1>
...
<form method="post" action="action.php" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-8">
            <label for="inputEmail4">Add Feature</label>
            <input type="text" class="form-control" name="feature" placeholder="Feature"  required>
            </div>
        </div>
        
        <button type="submit" onclick="return validate()" name="add_feature" class="btn btn-primary mt-5 ml-5">Add Image</button>
    </form>    
